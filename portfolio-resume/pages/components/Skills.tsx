  ...
  return (
    ...
    className='h-screen flex relative flex-col text-center md:text-left xl:flex-row- max-w-[2000px] xl:px-10 nub-h-screen justify-center xl:space-y-0 mx-auto items-center'>
        ...
        <div className='grid grid-cols-4 gap-5 pt-[75px]'>
            ...
            <Skill image="https://cdn.iconscout.com/icon/free/png-256/ruby-2752084-2284901.png" skillLevel="70%" />
            ...
            <Skill image="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Visual_Studio_Code_1.35_icon.svg/2048px-Visual_Studio_Code_1.35_icon.svg.png" skillLevel="75%" />
            <Skill image="https://pajaaleksic.com/wp-content/uploads/2019/07/react-native-workshop.jpg" skillLevel="65%" />
            ...
            <Skill image="https://www.rlogical.com/wp-content/uploads/2021/08/Rlogical-Blog-Images-thumbnail.png" skillLevel="15%" />
            {/* <Skill />
            <Skill />
            <Skill />
            <Skill />
